...
public class ButtonsPane implements AppComponent {
    ...
    private void onBuildButton() {
        State.get().getProgramState().updateMode(ProgramMode.DIAGRAM);
        logger.debug("Build Voronoi Diagram pressed!");
    }
    ...
    private class ButtonsFlow extends JPanel {
        ...
        private JPanel createTopSubpane() {
            ...
            JToggleButton pointsBtn = createToggleButton("Points", ButtonsPane.this::onPointsBtn);
            JToggleButton diagramBtn = createToggleButton("Build Voronoi Diagram", ButtonsPane.this::onBuildButton);
            JToggleButton eraseBtn = createToggleButton("Erase", ButtonsPane.this::onEraseButton);


            btnGroup.add(pointsBtn);
            btnGroup.add(diagramBtn);
            btnGroup.add(eraseBtn);

            subpanel.add(pointsBtn);
            subpanel.add(diagramBtn);
