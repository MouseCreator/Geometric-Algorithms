...
import mouse.project.algorithm.ForturnsAlgorithm;
...
public class PaintingPane implements AppComponent, ProgramModeListener, EventListener {
    ...
    public PaintingPane() {
        ...
        algorithm = new ForturnsAlgorithm(graphicsChangeListener);
    ...
    private List<ClickHandler> createClickHandlers() {
        ...
        handlers.add(new DiagramClickListener());
    ...
    public class RightClickHandlerImpl implements ClickHandler {
        ...
        @Override
        public void press(Position position) {
            if (State.get().getProgramState().getMode()==ProgramMode.DIAGRAM) {
                return;
            }
    ...
    private class DiagramClickListener implements ClickHandler {
        @Override
        public boolean isApplied(ProgramMode mode) {
            return mode == ProgramMode.DIAGRAM;
        }
